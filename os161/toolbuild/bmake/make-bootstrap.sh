...
srcdir=/home/account3/os161/toolbuild/bmake

DEFAULT_SYS_PATH="/home/account3/os161/tools/share/mk"
...
CC="gcc"
CFLAGS="-g -O2 -I. -I${srcdir} -DHAVE_CONFIG_H  -I/home/account3/os161/toolbuild/bmake/missing -DNEED_HOST_CDEFS_H -DMAKE_NATIVE ${XDEFS}"
